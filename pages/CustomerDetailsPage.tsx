  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        <Link
          to="/admin/customers"
          className="text-sm text-accent hover:underline flex items-center gap-2 mb-4"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-4 w-4"
                        ...
                        >
                          <ul className="py-1">
                            <li>
                              <button
                                onClick={() =>
                                  handleShare("whatsapp", order, customer)
                                }
                            ...
                            <li>
                              <button
                                onClick={() =>
                                  handleShare("email", order, customer)
                                }
                                className="w-full text-start px-4 py-2 text-sm text-text-primary hover:bg-card-secondary flex items-center gap-3"
                              >
