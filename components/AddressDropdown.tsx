...
const palestinianLocations = [
  "القدس", "رام الله", "الخليل", "نابلس", "جنين", "طولكرم", "قلقيلية", "بيت لحم", "أريحا",
  "غزة", "خانيونس", "رفح", "يافا", "حيفا", "عكا", "الناصرة", "اللد", "الرملة", "أم الفحم",
  "الطيبة", "الطيرة", "كفر قاسم", "الشيخ جراح", "سلوان", "بيت حنينا","عناتا", "شعفاط", "وادي الجوز",
  "طوباس", "سلفيت", "البيرة", "يطا", "الظاهرية", "دورا", "بيت ساحور", "بيت جالا", "عنبتا",
  "البلدة القديمة (القدس)", "البلدة القديمة (الخليل)", "البلدة القديمة (نابلس)"
...
const AddressDropdown: React.FC<AddressDropdownProps> = ({ value, onChange, label, name, id, required = false }) => {
    ...
    useEffect(() => {
        if (value) {
            ...
            setIsOpen(filtered.length > 0 && document.activeElement === wrapperRef.current?.querySelector('input'));
        } else {
