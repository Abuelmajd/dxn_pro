...
const LoadingSpinner: React.FC = () => (
  <div className="flex flex-col items-center justify-center h-screen bg-background text-text-primary overflow-hidden">
    <div className="relative flex items-center justify-center w-64 h-64">
      ...
      <div
        className="absolute bottom-0 right-1/2 translate-x-1/2 translate-y-1/2 animate-orbit"
      ...
      <div
        className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 animate-orbit"
    ...
    <h1 className="mt-12 text-2xl font-bold tracking-wider text-text-primary animate-pulse">
      جاري تجهيز الصفحة وتحميل البيانات...
    </h1>
...
const ErrorDisplay: React.FC<{ message: string }> = ({ message }) => (
  <div className="flex flex-col items-center justify-center h-screen bg-red-500/10 text-red-500 dark:text-red-400 p-4">
    ...
    <p className="mt-4 text-sm">
      يرجى التأكد من صحة رابط Google Apps Script في الكود، ومنح الأذونات
      اللازمة، وتحديث الصفحة. يمكنك استخدام أداة فحص الإعدادات لتشخيص المشكلة.
    </p>
  </div>
);
      ...
      <main className="flex-1 p-4 md:p-6 lg:p-8">
        <Routes>
          ...
          <Route
            ...
            element={<CustomerSelectionsListPage />}
          />
